...
-- 类型
INSERT INTO gar_resource_dynamic_props (id, type, application_id, tenant_id, filed_name, description, actions, remark, created_time, modified_time, updated_by_user_name) VALUES ('96', 'level_app', '1', '1', 'varchar00', 'fieldname', 'read', '应用级权限', '1528041600000', '1528041600000', 'admin');
INSERT INTO gar_resource_dynamic_props (id, type, application_id, tenant_id, filed_name, description, actions, remark, created_time, modified_time, updated_by_user_name) VALUES ('97', 'level_app', '1', '1', 'varchar01', '填true/false', 'read', '应用级权限', '1528041600000', '1528041600000', 'admin');
INSERT INTO gar_resource_dynamic_props (id, type, application_id, tenant_id, filed_name, description, actions, remark, created_time, modified_time, updated_by_user_name) VALUES ('98', 'level_tenant', '1', '1', 'varchar00', 'fieldname', 'read', '租户级权限', '1528041600000', '1528041600000', 'admin');
INSERT INTO gar_resource_dynamic_props (id, type, application_id, tenant_id, filed_name, description, actions, remark, created_time, modified_time, updated_by_user_name) VALUES ('99', 'level_tenant', '1', '1', 'varchar01', '填true/false', 'read', '租户级权限', '1528041600000', '1528041600000', 'admin');
INSERT INTO gar_resource_dynamic_props (id, type, application_id, tenant_id, filed_name, description, actions, remark, created_time, modified_time, updated_by_user_name) VALUES ('100', 'level_tenant_app', '1', '1', 'varchar00', 'fieldname', 'read', '租户+应用级权限', '1528041600000', '1528041600000', 'admin');
INSERT INTO gar_resource_dynamic_props (id, type, application_id, tenant_id, filed_name, description, actions, remark, created_time, modified_time, updated_by_user_name) VALUES ('101', 'level_tenant_app', '1', '1', 'varchar01', '填true/false', 'read', '租户+应用级权限', '1528041600000', '1528041600000', 'admin');
...
INSERT INTO gar_resources (id, application_id, path, actions, name, created_time, modified_time, type, tenant_id, varchar_00, varchar_01, updated_by_user_name) VALUES (84, 1, '/garnet/tenantupdate/editable', '', '租户编辑确认按钮读写权限', 1522252800000, 1522252800000, 'tenant_editable', 1, 'tenantUpdateButton', 'true', 'admin');
...
INSERT INTO gar_resources (id, application_id, path, actions, name, created_time, modified_time, type, tenant_id, varchar_00, varchar_01, updated_by_user_name) VALUES (85, 1, '/garnet/appupdate/editable', '', '应用编辑确认按钮读写权限', 1522252800000, 1522252800000, 'application_editable', 1, 'appUpdateButton', 'true', 'admin');
...
INSERT INTO gar_resources (id, application_id, path, actions, name, created_time, modified_time, type, tenant_id, varchar_00, varchar_01, updated_by_user_name) VALUES (86, 1, '/garnet/groupupdate/editable', '', '组编辑确认按钮读写权限', 1522252800000, 1522252800000, 'group_editable', 1, 'groupUpdateButton', 'true', 'admin');
...
INSERT INTO gar_resources (id, application_id, path, actions, name, created_time, modified_time, type, tenant_id, varchar_00, varchar_01, updated_by_user_name) VALUES (87, 1, '/garnet/roleselectpermission/editable', '', '角色编辑确认按钮读写权限', 1522252800000, 1522252800000, 'role_editable', 1, 'roleUpdateButton', 'true', 'admin');
-- 类型（应用级、租户级、租户+应用）控制
