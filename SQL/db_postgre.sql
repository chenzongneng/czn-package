...
INSERT INTO "public"."gar_sys_menu" ("menu_id", "parent_id", "name", "url", "perms", "type", "icon", "order_num") VALUES ('31', '1', '部门管理', 'modules/sys/dept.html', NULL, '1', 'fa fa-file-code-o', '2');
